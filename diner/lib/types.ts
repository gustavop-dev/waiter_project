...
export interface Dish { id: number; nombre: string; precio: number; agotado: boolean; categorias: number[]; descripcion?: string; foto?: string | null; favorito?: boolean }
export interface Category { id: number; nombre: string; productos: Dish[] }
export interface Menu { restaurante: string; categorias: Category[] }
