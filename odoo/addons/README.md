...
```
odoo -d <db> -i pos_restaurant,pos_self_order,pos_hr,hr_attendance,loyalty,pos_loyalty,mrp,purchase,projectapp_ops,projectapp_kitchen,projectapp_notify --stop-after-init
```
...
```
cd odoo/compose
docker compose -p odoo-spike exec -T odoo odoo -d projectapp -i projectapp_notify -u projectapp_ops,projectapp_kitchen --stop-after-init
...
```
odoo -d kittest -u projectapp_ops,projectapp_kitchen,projectapp_notify --test-enable --test-tags /projectapp_ops,/projectapp_kitchen,/projectapp_notify --stop-after-init
```
