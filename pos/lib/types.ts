...
export interface Settings { configId: number; configName: string; waiterCanCharge: boolean; alertLateMinutes: number; alertBillMinutes: number; roiHourCost: number; roiMinutesPerOrder: number; roiBaselineHoursPer100: number; roiMonthlyCost: number; roiStartDate: string | null; tipProductId: number | null }
