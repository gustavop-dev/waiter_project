...
const view = { table, state: 'billing' as const, total: 73600, orderId: 9, startedAt: '2026-09-04 20:00:00', waiter: 'Alejandra' }
...
it('offers to open the order instead of a zero bill on a free table', () => {
  wrap(<BillPanel view={{ table, state: 'free', total: 0, orderId: null, startedAt: null, waiter: null }} lines={[]} onCharge={jest.fn()} onOpenOrder={jest.fn()} now={NOW} />)
