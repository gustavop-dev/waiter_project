...
const SETTINGS = { configId: 1, configName: 'Salón', waiterCanCharge: true, alertLateMinutes: 18, alertBillMinutes: 10, roiHourCost: 20000, roiMinutesPerOrder: 11, roiBaselineHoursPer100: 18.4, roiMonthlyCost: 2740000, roiStartDate: null, tipProductId: 1 }
