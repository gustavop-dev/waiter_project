...
const base = { id: 3, templateId: 3, name: 'Burrata italiana', price: 32900, categoryIds: [1], taxIds: [], favorite: false, storable: false, soldOut: false }
...
it('marks a sold out product and blocks adding it', () => {
  wrap(<ProductCard product={{ ...base, storable: true, soldOut: true }} onAdd={jest.fn()} />)
