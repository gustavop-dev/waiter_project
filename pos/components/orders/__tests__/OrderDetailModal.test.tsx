...
const line = (id: number, name: string, courseId: number | null, note = ''): KitLine => ({ id, uuid: `u${id}`, productId: 3, name, qty: 1, unitPrice: 36900, subtotal: 36900, total: 43911, note, courseId })
